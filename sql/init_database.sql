...
-- 3.1 管理员
-- ---------------------------------------------
-- 密码: admin123（AES加密: bVsxzQ5cCjXRg1Dlb8n1ig==）
INSERT INTO admins (username, password_hash, real_name, role, phone) VALUES
('admin',  'bVsxzQ5cCjXRg1Dlb8n1ig==', '超级管理员', 'SUPER_ADMIN', '13800000000'),
('manager','bVsxzQ5cCjXRg1Dlb8n1ig==', '运营经理',   'MANAGER',     '13800000001')
...
('d001', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '张伟',   '内科',       '主任医师',   1),
('d002', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '李芳',   '外科',       '副主任医师', 1),
('d003', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '王建国', '检验科',     '主管技师',   1),
('d004', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '陈敏',   '放射科',     '主治医师',   1),
('d005', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '刘洋',   '超声科',     '副主任医师', 1),
('d006', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '赵丽华', '心电图室',   '主治医师',   1),
('d007', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '孙明',   '眼科',       '主任医师',   1),
('d008', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '周晓燕', '耳鼻喉科',   '主治医师',   1),
('d009', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '吴国强', '口腔科',     '副主任医师', 1),
('d010', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '郑雪',   '妇科',       '主任医师',   1)
ON DUPLICATE KEY UPDATE username = username;
...
('13900000001', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '赵小明', '110101199001011234', 1, '1990-01-01', 1, FALSE),
('13900000002', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '钱小红', '110102199205062345', 2, '1992-05-06', 1, FALSE),
('13900000003', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '孙大伟', '110103198512253456', 1, '1985-12-25', 1, FALSE),
('13900000004', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '李美丽', '110104199508084567', 2, '1995-08-08', 1, FALSE),
('13900000005', 'bVsxzQ5cCjXRg1Dlb8n1ig==', '周建国', '110105196503035678', 1, '1965-03-03', 1, FALSE)
